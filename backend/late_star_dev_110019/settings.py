"""
Django settings for late_star_dev_110019 project.
...
ROOT_URLCONF = 'late_star_dev_110019.urls'
...
WSGI_APPLICATION = 'late_star_dev_110019.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_star_dev_110019 API",
    "DESCRIPTION": "API documentation for late_star_dev_110019 App",
    "VERSION": "v1",
}
